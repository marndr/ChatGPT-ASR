...
OUTPUT_FILE = os.path.join(root,"results/results_GPT-3.5-Turbo/results_lowest_word_confidence/results_find_thresh_lowest_word_confidence/results_whisper.md")
output_file = os.path.join(root,"results/results_GPT-3.5-Turbo/results_lowest_word_confidence/results_find_thresh_lowest_word_confidence/plots/Wer_versus_confidence_plot.png")
