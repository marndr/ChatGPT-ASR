...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root, "results/results_GPT-3.5-Turbo/results_certain_low_confidence_words/whisper_corrected_transcriptions_Thresh=0.9.json")
