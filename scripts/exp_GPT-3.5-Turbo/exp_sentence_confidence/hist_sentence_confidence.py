...
OUTPUT_FILE = os.path.join(Root,"results/experiment_GPT-3.5-Turbo/results_sentence_confidence/results_find_thresh_sentece_confidence/plots/histogram_sentence_confidence_plot.png")
