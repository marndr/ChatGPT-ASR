...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root, "results/results_lowest_word_confidence/results_GPT-4-Turbo/results_without_lowest_word_confidence_GPT-4-Turbo/whisper_corrected_transcriptions.json") 
