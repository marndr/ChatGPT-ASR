...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_best_prompt/results_try_different_prompts/whisper_corrected_transcriptions_10.json")  
    ...
    messages = [
        {
            ...
            You will be presented with an ASR transcription of Librispeech data from the Dev Clean subset provided by the Whisper model,\
            delimited by {delimiter} characters.\
            ...
            Additionally, correct errors using probable homophones when applicable. 
