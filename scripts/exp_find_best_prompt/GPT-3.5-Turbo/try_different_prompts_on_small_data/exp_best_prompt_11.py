...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_best_prompt/results_try_different_prompts/whisper_corrected_transcriptions_11.json")  
...
def get_messages_exp1(asr_transcription, delimiter="####"):
    messages = [
        ...
        {
            'role': 'user',
            'content': '{"text": "For him, the criminal is the prisoner. Simple as a knot."}'
        },
        {'role': 'assistant', 'content': "For him, the criminal is the prisoner. Simple is it not."},
