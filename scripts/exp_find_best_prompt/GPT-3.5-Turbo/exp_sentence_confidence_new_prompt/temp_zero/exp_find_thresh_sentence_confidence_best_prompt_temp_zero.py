...
l=os.path.join(Root,"results/results_best_prompt/results_sentence_confidence_new_prompt/temp_zero/results_without_sentence_confidence/whisper_corrected_transcriptions_sentence_confidence_temp_zero.json")
OUTPUT_FILE = os.path.join(Root,"results/results_best_prompt/results_sentence_confidence_new_prompt/temp_zero/results_find_thresh_sentence_confidence/results_whisper.md")
output_file_wer = os.path.join(Root,"results/results_best_prompt/results_sentence_confidence_new_prompt/temp_zero/results_find_thresh_sentence_confidence/plots/Wer_vs_sentence_confidence_plot.png")
output_file_cer = os.path.join(Root,"results/results_best_prompt/results_sentence_confidence_new_prompt/temp_zero/results_find_thresh_sentence_confidence/plots/Cer_vs_sentence_confidence_plot.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs sentence confidence for GPT-3.5-Turbo (new prompt, temp=0)")
    ...
    plt.xlabel("sentence confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs sentence confidence for GPT-3.5-Turbo (new prompt, temp=0)")
