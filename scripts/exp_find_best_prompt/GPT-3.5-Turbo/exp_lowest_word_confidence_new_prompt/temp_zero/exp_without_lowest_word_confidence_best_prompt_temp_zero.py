...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_best_prompt/results_lowest_word_confidence_new_prompt/temp_zero/results_without_lowest_word_confidence/whisper_corrected_transcriptions_lowest_word_confidence_temp_zero.json")  
