...
l=os.path.join(Root,"results/results_best_prompt/results_lowest_word_confidence_new_prompt/temp_0.5/results_without_lowest_word_confidence/whisper_corrected_transcriptions_lowest_word_confidence_temp_0.5.json")
OUTPUT_FILE = os.path.join(Root,"results/results_best_prompt/results_lowest_word_confidence_new_prompt/temp_0.5/results_find_thresh_lowest_word_confidence/results_whisper.md")
output_file_wer = os.path.join(Root,"results/results_best_prompt/results_lowest_word_confidence_new_prompt/temp_0.5/results_find_thresh_lowest_word_confidence/plots/Wer_vs_confidence_plot.png")
output_file_cer = os.path.join(Root,"results/results_best_prompt/results_lowest_word_confidence_new_prompt/temp_0.5/results_find_thresh_lowest_word_confidence/plots/Cer_vs_confidence_plot.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs lowest word confidence for GPT-3.5-Turbo (new prompt, temp=0.5)")
    ...
    plt.xlabel("lowest word confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs lowest word confidence for GPT-3.5-Turbo (new prompt, temp=0.5)")
