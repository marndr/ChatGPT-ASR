...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_tiny/results_best_prompt/results_sentence_confidence_new_prompts/results_find_best_prompt/whisper_corrected_transcriptions_3.json")  
