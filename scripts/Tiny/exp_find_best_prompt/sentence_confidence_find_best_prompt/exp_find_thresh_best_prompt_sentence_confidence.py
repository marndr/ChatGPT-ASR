...
l=os.path.join(Root,"results/results_tiny/results_best_prompt/results_sentence_confidence_new_prompts/results_find_best_prompt/whisper_corrected_transcriptions_2.json")
OUTPUT_FILE = os.path.join(Root,"results/results_tiny/results_best_prompt/results_sentence_confidence_new_prompts/results_find_thresh_best_prompt/results_find_thresh_2.md")
output_file_wer = os.path.join(Root,"results/results_tiny/results_best_prompt/results_sentence_confidence_new_prompts/results_find_thresh_best_prompt/plots/Wer_vs_sentence_confidence_plot_2.png")
output_file_cer = os.path.join(Root,"results/results_tiny/results_best_prompt/results_sentence_confidence_new_prompts/results_find_thresh_best_prompt/plots/Cer_vs_sentence_confidence_plot_2.png")
