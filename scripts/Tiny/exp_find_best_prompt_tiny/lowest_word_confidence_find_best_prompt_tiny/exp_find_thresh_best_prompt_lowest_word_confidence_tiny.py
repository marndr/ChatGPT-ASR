...
l=os.path.join(Root,"results/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/results_lowest_word_confidence_new_prompts_tiny/results_find_best_prompt_tiny/corrected_transcriptions_lowest_word_confidence_prompt_2.json")
OUTPUT_FILE = os.path.join(Root,"results/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/results_thresh_lowest_word_confidence_prompt_2_tiny.md")
output_file_wer = os.path.join(Root,"results/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/plots_lowest_word_confidence_tiny/Wer_vs_lowest_word_confidence_prompt_2_tiny.png")
output_file_cer = os.path.join(Root,"results/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/plots_lowest_word_confidence_tiny/Cer_vs_lowest_word_confidence_prompt_2_tiny.png")
