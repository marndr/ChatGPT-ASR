...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/results_sentence_confidence_new_prompts_tiny/results_find_best_prompt_tiny/corrected_transcriptions_sentence_confidence_prompt_2.json")  
