...
l=os.path.join(Root,"results/results_tiny/results_sentence_confidence_tiny/results_GPT-3.5-Turbo_tiny/results_without_sentence_confidence_tiny/corrected_transcriptions_sentence_confidence_tiny.json")
OUTPUT_FILE = os.path.join(Root,"results/results_tiny/results_sentence_confidence_tiny/results_GPT-3.5-Turbo_tiny/results_find_thresh_sentence_confidence_tiny/results_thresh_sentence_confidence_tiny.md")
output_file_wer = os.path.join(Root,"results/results_tiny/results_sentence_confidence_tiny/results_GPT-3.5-Turbo_tiny/results_find_thresh_sentence_confidence_tiny/plots_sentence_confidence_tiny/Wer_vs_sentence_confidence_plot_tiny.png")
output_file_cer = os.path.join(Root,"results/results_tiny/results_sentence_confidence_tiny/results_GPT-3.5-Turbo_tiny/results_find_thresh_sentence_confidence_tiny/plots_sentence_confidence_tiny/Cer_vs_sentence_confidence_plot_tiny.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs sentence confidence for GPT-3.5-Turbo(tiny whisper model)")
    ...
    plt.xlabel("sentence confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs sentence confidence for GPT-3.5-Turbo(tiny whisper model)")
