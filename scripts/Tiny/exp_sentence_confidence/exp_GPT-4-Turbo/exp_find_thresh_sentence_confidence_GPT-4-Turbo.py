...
l=os.path.join(Root,"results/results_sentence_confidence/results_GPT-4-Turbo/results_without_sentence_confidence_GPT-4-Turbo/whisper_corrected_transcriptions.json")
OUTPUT_FILE = os.path.join(Root,"results/results_sentence_confidence/results_GPT-4-Turbo/results_find_thresh_sentence_confidence_GPT-4-Turbo/results_whisper.md")
output_file_wer = os.path.join(Root,"results/results_sentence_confidence/results_GPT-4-Turbo/results_find_thresh_sentence_confidence_GPT-4-Turbo/plots/Wer_vs_sentence-confidence_plot.png")
output_file_cer = os.path.join(Root,"results/results_sentence_confidence/results_GPT-4-Turbo/results_find_thresh_sentence_confidence_GPT-4-Turbo/plots/Cer_vs_sentence-confidence_plot.png")
