...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root, "results/results_sentence_confidence/results_GPT-4-Turbo/results_without_sentence_confidence_GPT-4-Turbo/whisper_corrected_transcriptions.json")  
