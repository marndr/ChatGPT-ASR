...
output_file_wer = os.path.join(Root,"results/results_sentence_confidence/results_GPT-3.5-Turbo/results_find_thresh_sentence_confidence/plots/Wer_vs_sentence_confidence_plot.png")
output_file_cer = os.path.join(Root,"results/results_sentence_confidence/results_GPT-3.5-Turbo/results_find_thresh_sentence_confidence/plots/Cer_vs_sentence_confidence_plot.png")
...
def plot(l):
    ...
    plt.xlabel("sentence confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs sentence confidence for GPT-3.5-Turbo")
