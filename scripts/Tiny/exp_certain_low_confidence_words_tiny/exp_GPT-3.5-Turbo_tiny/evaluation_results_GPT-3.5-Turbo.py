...
output_file = os.path.join(Root,"results/results_tiny/results_certain_low_confidence_words_tiny/results_GPT-3.5-Turbo_tiny/plots_certain_low_confidence_words_tiny/Wer_vs_certain_low_confidence_plot_tiny.png")
