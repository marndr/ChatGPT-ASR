...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_tiny/results_certain_low_confidence_words_tiny/results_GPT-3.5-Turbo_tiny/preprocessed_corrected_transcription_certain_low_confidence_words_tiny/preprocessed_corrected_transcriptions_Thresh=0.8_tiny.json")
