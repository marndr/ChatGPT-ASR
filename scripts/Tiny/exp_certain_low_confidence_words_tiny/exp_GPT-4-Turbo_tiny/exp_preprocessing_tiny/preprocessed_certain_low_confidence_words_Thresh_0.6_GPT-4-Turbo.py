...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root, "results/results_tiny/results_certain_low_confidence_words_tiny/results_GPT-4-Turbo_tiny/preprocessed_corrected_transcription_certain_low_confidence_words_tiny/preprocessed_corrected_transcriptions_Thresh=0.6_tiny.json")
...
if __name__ =="__main__":  
    ...
    l= multithread_parallelization(data1, get_messages_fn=get_messages_exp,model = "gpt-4-1106-preview")
