...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_tiny/results_average_word_confidence_tiny/results_GPT-4-Turbo_tiny/results_without_average_word_confidence_GPT-4-Turbo_tiny/corrected_transcriptions_average_word_confidence_GPT-4-Turbo_tiny.json")  
