...
OUTPUT_FILE = os.path.join(Root,"results/results_tiny/results_lowest_word_confidence_tiny/results_GPT-3.5-Turbo_tiny/results_find_thresh_lowest_word_confidence_tiny/results_thresh_lowest_word_confidence_tiny.md")
output_file_wer = os.path.join(Root,"results/results_tiny/results_lowest_word_confidence_tiny/results_GPT-3.5-Turbo_tiny/results_find_thresh_lowest_word_confidence_tiny/plots_lowest_word_confidence_tiny/Wer_vs_lowest_word_confidence_plot_tiny.png")
output_file_cer = os.path.join(Root,"results/results_tiny/results_lowest_word_confidence_tiny/results_GPT-3.5-Turbo_tiny/results_find_thresh_lowest_word_confidence_tiny/plots_lowest_word_confidence_tiny/Cer_vs_lowest_word_confidence_plot_tiny.png")
