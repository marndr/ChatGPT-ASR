...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root, "results/results_certain_low_confidence_words/results_GPT-3.5-Turbo/preprocessed_corrected_transcription/whisper_corrected_transcriptions_Thresh=0.6.json")
