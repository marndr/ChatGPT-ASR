...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root, "results/results_certain_low_confidence_words/results_GPT-4-Turbo/preprocessed_corrected_transcription_GPT-4-Turbo/whisper_corrected_transcriptions_Thresh=0.6.json")
