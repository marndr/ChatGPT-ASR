...
OUTPUT_FILE = os.path.join(root,"results/results_GPT-4/results_sentence_confidence_GPT-4/results_find_thresh_sentence_confidence_GPT-4/plots/histogram_sentence_confidence_plot_GPT-4.png")
