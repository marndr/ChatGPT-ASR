...
Example:
    python exp_find_thresh_sentence_confidence_noisy_test_large-v3.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-test-set/results_noisy/results_noisy_large-v3/results_sentence_confidence_noisy_large-v3/results_GPT-3.5-Turbo_noisy_large-v3/gpt-3.5-turbo-0125/results_find_thresh_sentence_confidence_noisy_large-v3/results_thresh_sentence_confidence_noisy_large-v3.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-test-set/results_noisy/results_noisy_large-v3/results_sentence_confidence_noisy_large-v3/results_GPT-3.5-Turbo_noisy_large-v3/gpt-3.5-turbo-0125/results_find_thresh_sentence_confidence_noisy_large-v3/plots_sentence_confidence_noisy_large-v3/Wer_vs_sentence_confidence_plot_noisy_large-v3.png",
)
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs sentence confidence for GPT-3.5-Turbo(large-v3, noisy, test-set)")
    ...
    plt.xlabel("sentence confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs sentence confidence for GPT-3.5-Turbo(large-v3, noisy, test-set)")
