...
Example:
    python exp_find_thresh_lowest_word_confidence_GPT-4-Turbo_noisy_test_large-v3.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results_noisy/results_noisy_large-v3/results_lowest_word_confidence_noisy_large-v3/results_GPT-4-Turbo_noisy_large-v3/gpt-4-0125-preview/results_find_thresh_lowest_word_confidence_GPT-4-Turbo_noisy_large-v3/results_thresh_lowest_word_confidence_noisy_large-v3.json",
)

output_file_wer = os.path.join(
    Root,
    "results/results_noisy/results_noisy_large-v3/results_lowest_word_confidence_noisy_large-v3/results_GPT-4-Turbo_noisy_large-v3/gpt-4-0125-preview/results_find_thresh_lowest_word_confidence_GPT-4-Turbo_noisy_large-v3/plots_lowest_word_confidence_GPT-4-Turbo_noisy_large-v3/Wer_vs_lowest_word_confidence_GPT-4-Turbo_plot_noisy_large-v3.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results_noisy/results_noisy_large-v3/results_lowest_word_confidence_noisy_large-v3/results_GPT-4-Turbo_noisy_large-v3/gpt-4-0125-preview/results_find_thresh_lowest_word_confidence_GPT-4-Turbo_noisy_large-v3/plots_lowest_word_confidence_GPT-4-Turbo_noisy_large-v3/Cer_vs_lowest_word_confidence_GPT-4-Turbo_plot_noisy_large-v3.png",
)
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs lowest word confidence for GPT-4-Turbo(noisy,large-v3)")
    ...
    plt.xlabel("lowest word confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs lowest word confidence for GPT-4-Turbo(noisy, large-v3)")
