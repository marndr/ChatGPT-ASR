...
Example:
    python exp_find_thresh_sentence_confidence_GPT-4-Turbo_noisy_test_medium.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-test-set/results_noisy/results_medium/results_sentence_confidence_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_medium/results_thresh_sentence_confidence_GPT-4-Turbo_medium.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-test-set/results_noisy/results_medium/results_sentence_confidence_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_medium/plots_sentence_confidence_GPT-4-Turbo_medium/Wer_vs_sentence_confidence_GPT-4-Turbo_plot_medium.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results-test-set/results_noisy/results_medium/results_sentence_confidence_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_medium/plots_sentence_confidence_GPT-4-Turbo_medium/Cer_vs_sentence_confidence_GPT-4-Turbo_plot_medium.png",
)
