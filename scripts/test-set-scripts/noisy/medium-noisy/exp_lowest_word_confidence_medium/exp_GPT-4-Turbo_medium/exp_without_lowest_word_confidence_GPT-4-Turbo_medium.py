...
TRANSCRIPTION_FILENAME = os.path.join(Root, "data/transcriptions/whisper_medium_librispeech_test-other-full.json") 

CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root, "results/results-test-set/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_without_lowest_word_confidence_GPT-4-Turbo_medium/corrected_transcriptions_lowest_word_confidence_GPT-4-Turbo_medium.json") 
