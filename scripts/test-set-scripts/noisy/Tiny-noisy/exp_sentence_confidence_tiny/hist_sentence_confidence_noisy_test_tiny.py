...
Example:
    python hist_sentence_confidencenoisy_test_tiny.py
"""
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-test-set/results_noisy/results_tiny/results_sentence_confidence_tiny/hist_sentence_confidence_tiny.png",
)
