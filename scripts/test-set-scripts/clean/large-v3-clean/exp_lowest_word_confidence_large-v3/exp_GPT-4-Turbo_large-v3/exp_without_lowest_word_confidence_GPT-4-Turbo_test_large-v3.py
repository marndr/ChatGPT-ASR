...
Example:
    python exp_without_lowest_word_confidence_GPT-4-Turbo_test_large-v3.py -d librispeech -n 1
...
TRANSCRIPTION_FILENAME = os.path.join(
    Root, "data/transcriptions/whisper_large-v3_librispeech_test-clean-full.json"
)
