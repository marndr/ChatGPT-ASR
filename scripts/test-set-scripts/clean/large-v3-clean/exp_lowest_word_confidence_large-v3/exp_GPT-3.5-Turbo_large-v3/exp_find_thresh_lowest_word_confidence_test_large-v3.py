...
Example:
    python exp_find_thresh_lowest_word_confidence_test_large-v3.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_large-v3/results_lowest_word_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_large-v3/results_thresh_lowest_word_confidence_large-v3.json",
)

output_file_wer = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_large-v3/results_lowest_word_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_large-v3/plots_lowest_word_confidence_large-v3/Wer_vs_lowest_word_confidence_plot_large-v3.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_large-v3/results_lowest_word_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_large-v3/plots_lowest_word_confidence_large-v3/Cer_vs_lowest_word_confidence_plot_large-v3.png",
)
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title(
        "Wer vs lowest word confidence for GPT-3.5-Turbo(large-v3, clean, test-set)"
    )
    ...
    plt.ylabel("Cer")
    plt.title(
        "Cer vs lowest word confidence for GPT-3.5-Turbo(large-v3, clean, test-set)"
    )
