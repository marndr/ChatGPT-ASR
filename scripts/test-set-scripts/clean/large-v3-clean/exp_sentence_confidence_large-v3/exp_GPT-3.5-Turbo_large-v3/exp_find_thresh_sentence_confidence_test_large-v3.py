...
Example:
    python exp_find_thresh_sentence_confidence_test_large-v3.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_large-v3/results_sentence_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_sentence_confidence_large-v3/results_thresh_sentence_confidence_large-v3.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_large-v3/results_sentence_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_sentence_confidence_large-v3/plots_sentence_confidence_large-v3/Wer_vs_sentence_confidence_plot_large-v3.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_large-v3/results_sentence_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_sentence_confidence_large-v3/plots_sentence_confidence_large-v3/Cer_vs_sentence_confidence_plot_large-v3.png",
)
