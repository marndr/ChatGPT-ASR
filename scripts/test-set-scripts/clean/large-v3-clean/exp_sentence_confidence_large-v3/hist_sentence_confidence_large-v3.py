...
OUTPUT_FILE = os.path.join(Root,"results/results-test-set/results_clean/results_large-v3/results_sentence_confidence_large-v3/hist_sentence_confidence_large-v3.png")
