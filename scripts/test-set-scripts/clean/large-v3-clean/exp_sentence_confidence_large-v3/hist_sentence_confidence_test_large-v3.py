...
Example:
    python hist_sentence_confidence_test_large-v3.py
"""
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_large-v3/results_sentence_confidence_large-v3/hist_sentence_confidence_large-v3.png",
)
...
plt.ylabel("count")
plt.title("Histogram of sentence confidence (large-v3, clean, test-set)")
