...
Example:
    python hist_lowest_word_confidence_test_tiny.py
"""
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_tiny/results_lowest_word_confidence_tiny/hist_lowest_word_confidence_tiny.png",
)
...
plt.ylabel("count")
plt.title("Histogram of lowest-word confidence(tiny, clean, test-set)")
