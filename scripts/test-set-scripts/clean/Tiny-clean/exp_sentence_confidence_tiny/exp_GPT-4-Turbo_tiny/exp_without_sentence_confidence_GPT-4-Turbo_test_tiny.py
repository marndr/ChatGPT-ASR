...
Example:
    python exp_without_sentence_confidence_GPT-4-Turbo_test_tiny.py -d librispeech -n 1
...
TRANSCRIPTION_FILENAME = os.path.join(
    Root, "data/transcriptions/whisper_tiny_librispeech_test-clean-full.json"
)
