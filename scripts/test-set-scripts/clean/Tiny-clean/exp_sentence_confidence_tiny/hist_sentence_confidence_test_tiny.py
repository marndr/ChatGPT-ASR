...
Example:
    python hist_sentence_confidence_test_tiny.py
"""
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-test-set/results_clean/results_tiny/results_sentence_confidence_tiny/hist_sentence_confidence_tiny.png",
)
