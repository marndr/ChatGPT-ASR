...
Example:
    python exp_without_lowest_word_confidence_GPT-4-Turbo_test_medium.py -d librispeech -n 1
...
TRANSCRIPTION_FILENAME = os.path.join(
    Root, "data/transcriptions/whisper_medium_librispeech_test-clean-full.json"
)
