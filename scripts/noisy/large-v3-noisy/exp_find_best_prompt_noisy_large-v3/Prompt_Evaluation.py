...
if __name__ == "__main__":
    ...
    parser.add_argument("-e","--experiment", choices = ["exp_new_prompt_sentence_confidence_1_noisy_large-v3","exp_new_prompt_lowest_word_confidence_1_noisy_large-v3"])
    args = parser.parse_args()
    
    
    
    if args.experiment =="exp_new_prompt_sentence_confidence_1_noisy_large-v3":
        CORRECTED_TRANSCRIPTIONS_LIBRISPEECH=os.path.join(Root,"results/results_noisy/results_noisy_large-v3/results_best_prompt_noisy_large-v3/results_GPT-3.5-Turbo_noisy_large-v3/gpt-3.5-turbo-1106/results_sentence_confidence_new_prompts_noisy_large-v3/results_find_best_prompt_noisy_large-v3/corrected_transcriptions_sentence_confidence_prompt_1.json")
        OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_noisy_large-v3/results_best_prompt_noisy_large-v3/results_GPT-3.5-Turbo_noisy_large-v3/gpt-3.5-turbo-1106/results_sentence_confidence_new_prompts_noisy_large-v3/results_find_best_prompt_noisy_large-v3/results_overall_sentence_confidence_prompt_1_noisy_large-v3.md")  
    ...
    if args.experiment =="exp_new_prompt_lowest_word_confidence_1_noisy_large-v3":
        ...
        OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_noisy_large-v3/results_best_prompt_noisy_large-v3/results_GPT-3.5-Turbo_noisy_large-v3/gpt-3.5-turbo-1106/results_lowest_word_confidence_new_prompts_noisy_large-v3/results_find_best_prompt_noisy_large-v3/results_overall_lowest_word_confidence_prompt_1_noisy_large-v3.md") 
