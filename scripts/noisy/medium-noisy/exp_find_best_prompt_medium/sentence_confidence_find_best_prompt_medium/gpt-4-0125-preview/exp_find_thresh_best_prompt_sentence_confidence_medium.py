...
l=os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/corrected_transcriptions_sentence_confidence_prompt_1.json")

OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-4-0125-preview/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/results_thresh_sentence_confidence_GPT-4-Turbo_medium.md")

output_file_wer = os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-4-0125-preview/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/Wer_vs_sentence_confidence_GPT-4-Turbo_plot_medium.png")

output_file_cer = os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-4-0125-preview/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/Cer_vs_sentence_confidence_GPT-4-Turbo_plot_medium.png")
