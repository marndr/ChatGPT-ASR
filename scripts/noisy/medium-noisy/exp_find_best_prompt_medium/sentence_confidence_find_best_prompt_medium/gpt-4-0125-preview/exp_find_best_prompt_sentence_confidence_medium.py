...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/corrected_transcriptions_sentence_confidence_prompt_1.json")  
