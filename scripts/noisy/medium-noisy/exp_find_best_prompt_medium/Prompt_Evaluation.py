...
if __name__ == "__main__":
    ...
    if args.experiment =="exp_new_prompt_sentence_confidence_1_medium":
        CORRECTED_TRANSCRIPTIONS_LIBRISPEECH=os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-0125/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/corrected_transcriptions_sentence_confidence_prompt_1.json")
        
        OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-0125/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/results_overall_sentence_confidence_prompt_1_medium.md")  
    
    if args.experiment =="exp_new_prompt_lowest_word_confidence_1_medium":
        CORRECTED_TRANSCRIPTIONS_LIBRISPEECH=os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-0125/results_lowest_word_confidence_new_prompts_medium/results_find_best_prompt_medium/corrected_transcriptions_lowest_word_confidence_prompt_1.json")
        
        OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-0125/results_lowest_word_confidence_new_prompts_medium/results_find_best_prompt_medium/results_overall_lowest_word_confidence_prompt_1_medium.md") 
    
    if args.experiment =="exp_new_prompt_sentence_confidence_1_GPT-4-Turbo_medium":
        CORRECTED_TRANSCRIPTIONS_LIBRISPEECH=os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/corrected_transcriptions_sentence_confidence_GPT-4-Turbo_prompt_1.json")
        
        OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_medium/results_best_prompt_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/results_overall_sentence_confidence_prompt_1_medium.md")                                   
