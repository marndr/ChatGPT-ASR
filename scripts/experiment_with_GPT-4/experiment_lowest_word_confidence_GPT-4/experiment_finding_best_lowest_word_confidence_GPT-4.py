...
OUTPUT_FILE = os.path.join(root,"results/results_GPT-4/results_lowest_word_confidence_GPT-4/results_finding_best_lowest_word_confidence_GPT-4/results_whisper.md")
output_file = os.path.join(root,"results/results_GPT-4/results_lowest_word_confidence_GPT-4/results_finding_best_lowest_word_confidence_GPT-4/plots/Wer_versus_confidence_plot.png")
