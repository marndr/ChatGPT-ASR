...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root, "results/results_lowest_confidence_words/results_GPT-4-Turbo/results_without_lowest_confidence_words_GPT-4-Turbo/whisper_corrected_transcriptions.json") 
