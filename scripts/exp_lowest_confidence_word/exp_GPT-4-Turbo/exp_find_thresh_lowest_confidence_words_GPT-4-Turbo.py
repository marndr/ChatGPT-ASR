...
l=os.path.join(Root,"results/results_lowest_confidence_word/results_GPT-4-Turbo/results_without_lowest_confidence_word_GPT-4-Turbo/whisper_corrected_transcriptions.json")
OUTPUT_FILE = os.path.join(Root,"results/results_lowest_confidence_word/results_GPT-4-Turbo/results_find_thresh_lowest_confidence_word_GPT-4-Turbo/results_whisper.md")
output_file_wer = os.path.join(Root,"results/results_lowest_confidence_word/results_GPT-4-Turbo/results_find_thresh_lowest_confidence_word_GPT-4-Turbo/plots/Wer_vs_lowest_confidence_plot.png")
output_file_cer = os.path.join(Root,"results/results_lowest_confidence_word/results_GPT-4-Turbo/results_find_thresh_lowest_confidence_word_GPT-4-Turbo/plots/Cer_vs_lowest_confidence_plot.png")
