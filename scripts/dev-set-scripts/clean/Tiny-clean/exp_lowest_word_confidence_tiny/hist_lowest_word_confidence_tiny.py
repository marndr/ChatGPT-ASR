...
Example:
    python hist_lowest_word_confidence_tiny.py
"""
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_tiny/results_lowest_word_confidence_tiny/hist_lowest_word_confidence_tiny.png",
)
