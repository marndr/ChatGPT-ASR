...
errors using GPT-3.5-Turbo model. It identifies low confidence words in ASR
...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_tiny/results_certain_low_confidence_words_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-1106/preprocessed_corrected_transcriptions_certain_low_confidence_words_tiny_new/preprocessed_corrected_transcriptions_Thresh=0.1_tiny.json",
)
...
if __name__ == "__main__":
    ...
    l = multithread_parallelization(
        data1, get_messages_fn=get_messages_exp, model="gpt-3.5-turbo-1106"
    )
