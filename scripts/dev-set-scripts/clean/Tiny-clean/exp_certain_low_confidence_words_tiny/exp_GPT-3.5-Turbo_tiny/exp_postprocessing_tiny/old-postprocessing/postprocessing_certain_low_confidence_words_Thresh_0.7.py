...
corrected_transcription_file = os.path.join(
    Root,
    "results/results_clean/results_tiny/results_certain_low_confidence_words_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-1106/preprocessed_corrected_transcription_certain_low_confidence_words_tiny/preprocessed_corrected_transcriptions_Thresh=0.7_tiny.json",
)
...
output_file = os.path.join(
    Root,
    "results/results_clean/results_tiny/results_certain_low_confidence_words_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-1106/postprocessed_corrected_transcription_certain_low_confidence_words_tiny/postprocessed_corrected_transcriptions_processed_Thresh=0.7_tiny.json",
)
