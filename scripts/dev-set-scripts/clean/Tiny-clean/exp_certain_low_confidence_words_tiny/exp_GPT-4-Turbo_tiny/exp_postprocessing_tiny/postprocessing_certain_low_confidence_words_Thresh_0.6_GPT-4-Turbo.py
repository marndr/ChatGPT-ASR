...
corrected_transcription_file = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_tiny/results_certain_low_confidence_words_tiny/results_GPT-4-Turbo_tiny/gpt-4-1106-preview/preprocessed_corrected_transcription_certain_low_confidence_words_tiny_new/preprocessed_corrected_transcriptions_Thresh=0.6_tiny.json",
)
...
output_file = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_tiny/results_certain_low_confidence_words_tiny/results_GPT-4-Turbo_tiny/gpt-4-1106-preview/postprocessed_corrected_transcription_certain_low_confidence_words_tiny_new/postprocessed_corrected_transcriptions_processed_Thresh=0.6_tiny.json",
)
