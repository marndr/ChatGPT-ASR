...
l = os.path.join(
    Root,
    "results/results_clean/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-1106/results_lowest_word_confidence_new_prompts_tiny/results_find_best_prompt_tiny/corrected_transcriptions_lowest_word_confidence_prompt_2.json",
)

OUTPUT_FILE = os.path.join(
    Root,
    "results/results_clean/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-1106/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/results_thresh_lowest_word_confidence_prompt_2_tiny.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results_clean/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-1106/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/plots_lowest_word_confidence_tiny/Wer_vs_lowest_word_confidence_prompt_2_tiny.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results_clean/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-1106/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/plots_lowest_word_confidence_tiny/Cer_vs_lowest_word_confidence_prompt_2_tiny.png",
)
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title(
        "Wer vs lowest word confidence for GPT-3.5-Turbo (new prompt-2, tiny, clean)"
    )
    ...
    plt.ylabel("Cer")
    plt.title(
        "Cer vs lowest word confidence for GPT-3.5-Turbo (new promt-2,tiny, clean)"
    )
