...
Example:
    python exp_find_thresh_sentence_confidence_GPT-4-Turbo_tiny.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_tiny/results_sentence_confidence_tiny/results_GPT-4-Turbo_tiny/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_tiny/results_thresh_sentence_confidence_GPT-4-Turbo_tiny.md",
)
output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_tiny/results_sentence_confidence_tiny/results_GPT-4-Turbo_tiny/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_tiny/plots_sentence_confidence_GPT-4-Turbo_tiny/Wer_vs_sentence-confidence_GPT-4-Turbo_plot_tiny.png",
)
output_file_cer = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_tiny/results_sentence_confidence_tiny/results_GPT-4-Turbo_tiny/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_tiny/plots_sentence_confidence_GPT-4-Turbo_tiny/Cer_vs_sentence-confidence_GPT-4-Turbo_plot_tiny.png",
)
