...
extracts confidence scores, and plots a histogram of the average word confidence scores.
The histogram is then saved as an image file.

Example:
    python hist_average_word_confidence_tiny.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_tiny/results_average_word_confidence_tiny/hist_average_word_confidence_tiny.png",
)
