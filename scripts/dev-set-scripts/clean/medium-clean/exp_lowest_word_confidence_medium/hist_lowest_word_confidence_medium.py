...
Example:
    python hist_lowest_word_confidence_medium.py
"""
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_medium/results_lowest_word_confidence_medium/hist_lowest_word_confidence_medium.png",
)
