...
Example:
    python exp_find_thresh_best_prompt_lowest_word_confidence_medium.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-1106/results_lowest_word_confidence_new_prompts_medium/results_find_thresh_best_prompt_medium/results_thresh_lowest_word_confidence_prompt_1_medium.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-1106/results_lowest_word_confidence_new_prompts_medium/results_find_thresh_best_prompt_medium/plots_lowest_word_confidence_medium/Wer_vs_lowest_word_confidence_prompt_1_medium.png",
)
