...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results_clean/results_medium/results_sentence_confidence_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-1106/results_find_thresh_sentence_confidence_medium/results_thresh_sentence_confidence_medium.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results_clean/results_medium/results_sentence_confidence_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-1106/results_find_thresh_sentence_confidence_medium/plots_sentence_confidence_medium/Wer_vs_sentence_confidence_plot_medium.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results_clean/results_medium/results_sentence_confidence_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-1106/results_find_thresh_sentence_confidence_medium/plots_sentence_confidence_medium/Cer_vs_sentence_confidence_plot_medium.png",
)
