...
Example:
    python exp_without_average_word_confidence_GPT-4-Turbo_large-v3.py -d librispeech -n 1
...
from chat_gpt_asr.utils import confidence_score_average_word_level
...
TRANSCRIPTION_FILENAME = os.path.join(
    Root, "data/transcriptions/whisper_large-v3_librispeech_dev-clean-full.json"
)
...
if __name__ == "__main__":
    ...
    if args.dataset == "librispeech":
        ...
        for i, d in enumerate(data):
            asr_transcription = confidence_score_average_word_level(
    ...
    l = multithread_parallelization(
        data, get_messages_fn=get_messages_exp, model="gpt-4-0125-preview"
    )
