...
Example:
    python exp_find_thresh_average_word_confidence_GPT-4-Turbo_large-v3.py
...
l = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-4-Turbo_large-v3/gpt-4-0125-preview/results_without_average_word_confidence_GPT-4-Turbo_large-v3/corrected_transcriptions_average_word_confidence_GPT-4-Turbo_large-v3.json",
)

OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-4-Turbo_large-v3/gpt-4-0125-preview/results_find_thresh_average_word_confidence_GPT-4-Turbo_large-v3/results_thresh_average_word_confidence_GPT-4-Turbo_large-v3.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-4-Turbo_large-v3/gpt-4-0125-preview/results_find_thresh_average_word_confidence_GPT-4-Turbo_large-v3/plots_average_word_confidence_GPT-4-Turbo_large-v3/Wer_vs_average_word_confidence_GPT-4-Turbo_plot_large-v3.png",
)
