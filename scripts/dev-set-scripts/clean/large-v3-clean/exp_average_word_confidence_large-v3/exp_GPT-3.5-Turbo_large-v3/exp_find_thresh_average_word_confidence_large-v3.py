...
Example:
    python exp_find_thresh_average_word_confidence_large-v3.py
...
l = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_without_average_word_confidence_large-v3/corrected_transcriptions_average_word_confidence_large-v3.json",
)

OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_average_word_confidence_large-v3/results_thresh_average_word_confidence_large-v3.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_average_word_confidence_large-v3/plots_average_word_confidence_large-v3/Wer_vs_average_word_confidence_plot_large-v3.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_find_thresh_average_word_confidence_large-v3/plots_average_word_confidence_large-v3/Cer_vs_average_word_confidence_plot_large-v3.png",
)
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs average word confidence for GPT-3.5-Turbo(large-v3, clean)")
    ...
    plt.xlabel("average word confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs average word confidence for GPT-3.5-Turbo(large-v3, clean)")
