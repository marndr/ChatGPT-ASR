...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-0125/results_without_average_word_confidence_large-v3/corrected_transcriptions_average_word_confidence_large-v3.json")  
...
if __name__ =="__main__": 
    ...
    l= multithread_parallelization(data, get_messages_fn=get_messages_exp,model = "gpt-3.5-turbo-0125")
