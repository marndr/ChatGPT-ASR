...
Example:
    python hist_lowest_word_confidence_large-v3.py
"""
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_lowest_word_confidence_large-v3/hist_lowest_word_confidence_large-v3.png",
)
