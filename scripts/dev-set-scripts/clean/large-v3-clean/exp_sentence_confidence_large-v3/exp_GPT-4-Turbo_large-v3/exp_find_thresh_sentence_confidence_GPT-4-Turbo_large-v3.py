...
Example:
    python exp_find_thresh_sentence_confidence_GPT-4-Turbo_large-v3.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_sentence_confidence_large-v3/results_GPT-4-Turbo_large-v3/gpt-4-1106-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_large-v3/results_thresh_sentence_confidence_GPT-4-Turbo_large-v3.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_sentence_confidence_large-v3/results_GPT-4-Turbo_large-v3/gpt-4-1106-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_large-v3/plots_sentence_confidence_GPT-4-Turbo_large-v3/Wer_vs_sentence_confidence_GPT-4-Turbo_plot_large-v3.png",
)
