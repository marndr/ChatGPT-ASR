...
if __name__ == "__main__":
    ...
    if args.experiment =="exp_new_prompt_sentence_confidence_1_large-v3":
        CORRECTED_TRANSCRIPTIONS_LIBRISPEECH=os.path.join(Root,"results/results_clean/results_large-v3/results_best_prompt_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-1106/results_sentence_confidence_new_prompts_large-v3/results_find_best_prompt_large-v3/corrected_transcriptions_sentence_confidence_prompt_1.json")
        
        OUTPUT_FILE = os.path.join(Root,"results/results_clean/results_large-v3/results_best_prompt_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-1106/results_sentence_confidence_new_prompts_large-v3/results_find_best_prompt_large-v3/results_overall_sentence_confidence_prompt_1_large-v3.md")  
