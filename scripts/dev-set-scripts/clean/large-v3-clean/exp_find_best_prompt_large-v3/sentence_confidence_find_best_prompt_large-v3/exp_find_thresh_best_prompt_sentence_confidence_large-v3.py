...
Example:
    python exp_find_thresh_best_prompt_sentence_confidence_large-v3.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_best_prompt_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-1106/results_sentence_confidence_new_prompts_large-v3/results_find_thresh_best_prompt_large-v3/results_thresh_sentence_confidence_prompt_1_large-v3.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_clean/results_large-v3/results_best_prompt_large-v3/results_GPT-3.5-Turbo_large-v3/gpt-3.5-turbo-1106/results_sentence_confidence_new_prompts_large-v3/results_find_thresh_best_prompt_large-v3/plots_sentence_confidence_large-v3/Wer_vs_sentence_confidence_prompt_1_large-v3.png",
)
