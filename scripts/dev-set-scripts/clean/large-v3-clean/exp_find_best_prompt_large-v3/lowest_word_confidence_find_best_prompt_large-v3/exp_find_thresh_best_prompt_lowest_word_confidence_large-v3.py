...
Example:
    python exp_find_thresh_best_prompt_lowest_confidence_large-v3.py
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title(
        "Wer vs lowest word confidence for GPT-3.5-Turbo (new prompt-2, large-v3, clean)"
    )
    ...
    plt.ylabel("Cer")
    plt.title(
        "Cer vs lowest word confidence for GPT-3.5-Turbo (new promt-2, large-v3, clean)"
    )
