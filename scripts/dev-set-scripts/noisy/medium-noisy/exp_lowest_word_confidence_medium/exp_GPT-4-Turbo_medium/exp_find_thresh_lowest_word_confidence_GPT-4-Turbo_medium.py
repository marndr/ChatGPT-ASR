...
l=os.path.join(Root,"results/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_without_lowest_word_confidence_GPT-4-Turbo_medium/corrected_transcriptions_lowest_word_confidence_GPT-4-Turbo_medium.json")

OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_find_thresh_lowest_word_confidence_GPT-4-Turbo_medium/results_thresh_lowest_word_confidence_medium.json")

output_file_wer = os.path.join(Root,"results/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_find_thresh_lowest_word_confidence_GPT-4-Turbo_medium/plots_lowest_word_confidence_GPT-4-Turbo_medium/Wer_vs_lowest_word_confidence_GPT-4-Turbo_plot_medium.png")

output_file_cer = os.path.join(Root,"results/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-4-Turbo_medium/gpt-4-0125-preview/results_find_thresh_lowest_word_confidence_GPT-4-Turbo_medium/plots_lowest_word_confidence_GPT-4-Turbo_medium/Cer_vs_lowest_word_confidence_GPT-4-Turbo_plot_medium.png")
