...
l=os.path.join(Root,"results/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-0125/results_without_lowest_word_confidence_medium/corrected_transcriptions_lowest_word_confidence_medium.json")

OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_medium/results_thresh_lowest_word_confidence_medium.json")

output_file_wer = os.path.join(Root,"results/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_medium/plots_lowest_word_confidence_medium/Wer_vs_lowest_word_confidence_plot_medium.png")

output_file_cer = os.path.join(Root,"results/results_noisy/results_medium/results_lowest_word_confidence_medium/results_GPT-3.5-Turbo_medium/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_medium/plots_lowest_word_confidence_medium/Cer_vs_lowest_word_confidence_plot_medium.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs lowest word confidence for GPT-3.5-Turbo(medium, noisy)")
    ...
    plt.xlabel("lowest word confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs lowest word confidence for GPT-3.5-Turbo(medium, noisy)")
