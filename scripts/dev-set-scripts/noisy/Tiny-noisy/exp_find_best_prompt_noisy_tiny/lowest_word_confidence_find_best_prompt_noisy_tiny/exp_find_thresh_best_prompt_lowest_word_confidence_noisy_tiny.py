...
Example:
    python exp_find_thresh_best_prompt_lowest_word_confidence_noisy_tiny.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_noisy/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/results_thresh_lowest_word_confidence_prompt_1_tiny.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_noisy/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/plots_lowest_word_confidence_tiny/Wer_vs_lowest_word_confidence_prompt_1_tiny.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results-dev-set/results_noisy/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_lowest_word_confidence_new_prompts_tiny/results_find_thresh_best_prompt_tiny/plots_lowest_word_confidence_tiny/Cer_vs_lowest_word_confidence_prompt_1_tiny.png",
)
