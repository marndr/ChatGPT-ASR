...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results_noisy/results_tiny/results_sentence_confidence_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_find_thresh_sentence_confidence_tiny/results_thresh_sentence_confidence_tiny.md",
)
output_file_wer = os.path.join(
    Root,
    "results/results_noisy/results_tiny/results_sentence_confidence_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_find_thresh_sentence_confidence_tiny/plots_sentence_confidence_tiny/Wer_vs_sentence_confidence_plot_tiny.png",
)
output_file_cer = os.path.join(
    Root,
    "results/results_noisy/results_tiny/results_sentence_confidence_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_find_thresh_sentence_confidence_tiny/plots_sentence_confidence_tiny/Cer_vs_sentence_confidence_plot_tiny.png",
)
