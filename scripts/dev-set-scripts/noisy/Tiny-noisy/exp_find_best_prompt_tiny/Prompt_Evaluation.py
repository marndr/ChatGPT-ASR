...
if __name__ == "__main__":
    ...
    parser.add_argument("-e","--experiment", choices = ["exp_new_prompt_sentence_confidence_1_tiny","exp_new_prompt_lowest_word_confidence_1_tiny"])
    args = parser.parse_args()
    
    
    if args.experiment == "exp_new_prompt_sentence_confidence_1_tiny":
        CORRECTED_TRANSCRIPTIONS_LIBRISPEECH=os.path.join(Root,"results/results_noisy/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_sentence_confidence_new_prompts_tiny/results_find_best_prompt_tiny/corrected_transcriptions_sentence_confidence_prompt_1.json")
        OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_sentence_confidence_new_prompts_tiny/results_find_best_prompt_tiny/results_overall_sentence_confidence_prompt_1_tiny.md")
    
    
    if args.experiment == "exp_new_prompt_lowest_word_confidence_1_tiny":
        CORRECTED_TRANSCRIPTIONS_LIBRISPEECH=os.path.join(Root,"results/results_noisy/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_lowest_word_confidence_new_prompts_tiny/results_find_best_prompt_tiny/corrected_transcriptions_lowest_word_confidence_prompt_1.json")
        OUTPUT_FILE = os.path.join(Root,"results/results_noisy/results_tiny/results_best_prompt_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_lowest_word_confidence_new_prompts_tiny/results_find_best_prompt_tiny/results_overall_lowest_word_confidence_prompt_1_tiny.md") 
