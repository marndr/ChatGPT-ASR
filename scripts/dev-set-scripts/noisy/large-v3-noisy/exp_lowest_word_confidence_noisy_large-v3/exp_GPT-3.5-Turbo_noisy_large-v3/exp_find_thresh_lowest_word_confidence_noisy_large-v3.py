...
Example:
    python exp_find_thresh_lowest_word_confidence_noisy_large-v3.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_noisy/results_noisy_large-v3/results_lowest_word_confidence_noisy_large-v3/results_GPT-3.5-Turbo_noisy_large-v3/gpt-3.5-turbo-1106/results_find_thresh_lowest_word_confidence_noisy_large-v3/results_thresh_lowest_word_confidence_noisy_large-v3.json",
)

output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_noisy/results_noisy_large-v3/results_lowest_word_confidence_noisy_large-v3/results_GPT-3.5-Turbo_noisy_large-v3/gpt-3.5-turbo-1106/results_find_thresh_lowest_word_confidence_noisy_large-v3/plots_lowest_word_confidence_noisy_large-v3/Wer_vs_lowest_word_confidence_plot_noisy_large-v3.png",
)
