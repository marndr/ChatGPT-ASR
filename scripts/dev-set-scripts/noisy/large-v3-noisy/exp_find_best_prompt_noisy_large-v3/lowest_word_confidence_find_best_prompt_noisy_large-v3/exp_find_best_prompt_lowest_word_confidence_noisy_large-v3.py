...
Example:
    python exp_find_best_prompt_lowest_word_confidence_noisy_large-v3.py -d librispeech -n 1
...
TRANSCRIPTION_FILENAME = os.path.join(
    Root, "data/transcriptions/whisper_large-v3_librispeech_dev-other-full.json"
)
