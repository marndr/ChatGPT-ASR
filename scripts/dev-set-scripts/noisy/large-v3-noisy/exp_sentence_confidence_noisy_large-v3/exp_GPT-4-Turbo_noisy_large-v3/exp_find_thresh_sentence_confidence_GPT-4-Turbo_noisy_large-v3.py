...
Example:
    python exp_find_thresh_sentence_confidence_GPT-4-Turbo_noisy_large-v3.py
...
OUTPUT_FILE = os.path.join(
    Root,
    "results/results-dev-set/results_noisy/results_noisy_large-v3/results_sentence_confidence_noisy_large-v3/results_GPT-4-Turbo_noisy_large-v3/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_noisy_large-v3/results_thresh_sentence_confidence_GPT-4-Turbo_noisy_large-v3.md",
)

output_file_wer = os.path.join(
    Root,
    "results/results-dev-set/results_noisy/results_noisy_large-v3/results_sentence_confidence_noisy_large-v3/results_GPT-4-Turbo_noisy_large-v3/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_noisy_large-v3/plots_sentence_confidence_GPT-4-Turbo_noisy_large-v3/Wer_vs_sentence_confidence_GPT-4-Turbo_plot_noisy_large-v3.png",
)

output_file_cer = os.path.join(
    Root,
    "results/results-dev-set/results_noisy/results_noisy_large-v3/results_sentence_confidence_noisy_large-v3/results_GPT-4-Turbo_noisy_large-v3/gpt-4-0125-preview/results_find_thresh_sentence_confidence_GPT-4-Turbo_noisy_large-v3/plots_sentence_confidence_GPT-4-Turbo_noisy_large-v3/Cer_vs_sentence_confidence_GPT-4-Turbo_plot_noisy_large-v3.png",
)
