...
l=os.path.join(Root,"results/results_clean/results_tiny/results_lowest_word_confidence_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_without_lowest_word_confidence_tiny/corrected_transcriptions_lowest_word_confidence_tiny.json")
OUTPUT_FILE = os.path.join(Root,"results/results_clean/results_tiny/results_lowest_word_confidence_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_tiny/results_thresh_lowest_word_confidence_tiny.md")
output_file_wer = os.path.join(Root,"results/results_clean/results_tiny/results_lowest_word_confidence_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_tiny/plots_lowest_word_confidence_tiny/Wer_vs_lowest_word_confidence_plot_tiny.png")
output_file_cer = os.path.join(Root,"results/results_clean/results_tiny/results_lowest_word_confidence_tiny/results_GPT-3.5-Turbo_tiny/gpt-3.5-turbo-0125/results_find_thresh_lowest_word_confidence_tiny/plots_lowest_word_confidence_tiny/Cer_vs_lowest_word_confidence_plot_tiny.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs lowest word confidence for GPT-3.5-Turbo(tiny, clean)")
    ...
    plt.xlabel("lowest word confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs lowest word confidence for GPT-3.5-Turbo(tiny, clean)")
