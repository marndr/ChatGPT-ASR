...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_clean/results_tiny/results_average_word_confidence_tiny/results_GPT-4-Turbo_tiny/gpt-4-1106-preview/results_without_average_word_confidence_GPT-4-Turbo_tiny/corrected_transcriptions_average_word_confidence_GPT-4-Turbo_tiny.json")  
...
if __name__ =="__main__": 
    ...
    l= multithread_parallelization(data, get_messages_fn=get_messages_exp,model = "gpt-4-1106-preview")
