...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_clean/results_large-v3/results_average_word_confidence_large-v3/results_GPT-4-Turbo_large-v3/gpt-4-0125-preview/results_without_average_word_confidence_GPT-4-Turbo_large-v3/corrected_transcriptions_average_word_confidence_GPT-4-Turbo_large-v3.json")  
...
if __name__ =="__main__": 
    ...
    if args.dataset == "librispeech":
        ...
        for i,d in enumerate(data):
            asr_transcription = confidence_score_average_word_level(d["asr_transcription"] , confidence = True) 
    ...
    l= multithread_parallelization(data, get_messages_fn=get_messages_exp,model = "gpt-4-0125-preview")
