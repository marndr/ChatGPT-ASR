...
output_file = os.path.join(Root,"results/results_average_word_confidence/results_GPT-4-Turbo/results_find_thresh_average_word_confidence_GPT-4-Turbo/plots/Wer_vs_confidence_plot.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs average confidence for GPT-4-Turbo")
