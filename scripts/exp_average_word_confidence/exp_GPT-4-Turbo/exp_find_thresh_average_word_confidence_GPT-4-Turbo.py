...
l=os.path.join(Root,"results/results_average_word_confidence/results_GPT-4-Turbo/results_without_average_word_confidence_GPT-4-Turbo/whisper_corrected_transcriptions.json")
OUTPUT_FILE = os.path.join(Root,"results/results_average_word_confidence/results_GPT-4-Turbo/results_find_thresh_average_word_confidence_GPT-4-Turbo/results_whisper.md")
output_file_wer = os.path.join(Root,"results/results_average_word_confidence/results_GPT-4-Turbo/results_find_thresh_average_word_confidence_GPT-4-Turbo/plots/Wer_vs_confidence_plot.png")
output_file_cer = os.path.join(Root,"results/results_average_word_confidence/results_GPT-4-Turbo/results_find_thresh_average_word_confidence_GPT-4-Turbo/plots/Cer_vs_confidence_plot.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs average word confidence for GPT-4-Turbo")
    ...
    plt.xlabel("average word confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs average word confidence for GPT-4-Turbo")
