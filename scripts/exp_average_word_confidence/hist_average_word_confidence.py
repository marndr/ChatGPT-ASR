...
OUTPUT_FILE = os.path.join(Root,"results/results_average_word_confidence/histogram_average_word_confidence.png")
...
plt.ylabel("count")
plt.title("Histogram of average-word confidence")
