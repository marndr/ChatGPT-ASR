...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_medium/results_best_prompt_medium/results_GPT-3.5-Turbo_medium/results_sentence_confidence_new_prompts_medium/results_find_best_prompt_medium/corrected_transcriptions_sentence_confidence_prompt_1.json")  
