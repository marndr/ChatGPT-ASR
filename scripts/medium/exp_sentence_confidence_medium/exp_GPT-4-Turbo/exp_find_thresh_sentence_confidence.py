...
l=os.path.join(Root,"results/results_medium/results_sentence_confidence_medium/results_GPT-4-Turbo_medium/results_without_sentence_confidence_GPT-4-Turbo/corrected_transcriptions_sentence_confidence_GPT-4-Turbo_medium.json")
