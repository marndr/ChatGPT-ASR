...
l=os.path.join(Root,"results/results_medium/results_sentence_confidence_medium/results_GPT-3.5-Turbo_medium/results_without_sentence_confidence_medium/corrected_transcriptions_sentence_confidence_medium.json")
OUTPUT_FILE = os.path.join(Root,"results/results_medium/results_sentence_confidence_medium/results_GPT-3.5-Turbo_medium/results_find_thresh_sentence_confidence_medium/results_thresh_sentence_confidence_medium.md")
output_file_wer = os.path.join(Root,"results/results_medium/results_sentence_confidence_medium/results_GPT-3.5-Turbo_medium/results_find_thresh_sentence_confidence_medium/plots_sentence_confidence_medium/Wer_vs_sentence_confidence_plot_medium.png")
output_file_cer = os.path.join(Root,"results/results_medium/results_sentence_confidence_medium/results_GPT-3.5-Turbo_medium/results_find_thresh_sentence_confidence_medium/plots_sentence_confidence_medium/Cer_vs_sentence_confidence_plot_medium.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs sentence confidence for GPT-3.5-Turbo(medium whisper model)")
    ...
    plt.xlabel("sentence confidence")
    plt.ylabel("Cer")
    plt.title("Cer vs sentence confidence for GPT-3.5-Turbo(medium whisper model)")
