...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_medium/results_sentence_confidence_medium/results_GPT-3.5-Turbo_medium/results_without_sentence_confidence_medium/corrected_transcriptions_sentence_confidence_medium.json")  
