...
output_file = os.path.join(Root,"results/results_sentence_confidence/results_GPT-4-Turbo/results_find_thresh_sentence_confidence_GPT-4-Turbo/plots/Wer_vs_sentence-confidence_plot.png")
...
def plot(l):
    ...
    plt.ylabel("Wer")
    plt.title("Wer vs sentence confidence for GPT-4-Turbo")
