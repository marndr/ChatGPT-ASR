...
CORRECTED_TRANSCRIPTION_FILENAME = os.path.join(Root,"results/results_sentence_confidence/results_GPT-3.5-Turbo/results_without_sentence_confidence/whisper_corrected_transcriptions.json")  
